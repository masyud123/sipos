...
<body>
    ...
    <div class="container">
                    ...
                    <tbody>
                        ...
                        foreach ($retur->result_array() as $items) : ?>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;"><a href="<?php echo base_url() . 'admin/retur/hapus_retur/' . $items['retur_id'] . "~" . $items['retur_barang_id'] . "~" . $items['retur_qty']; ?>" class="btn btn-warning btn-xs"><span class="fa fa-close"></span> Batal</a></td>
                            </tr>
        ...
        <script type="text/javascript">
            ...
            $("#kode_brg").keypress(function(event) {
