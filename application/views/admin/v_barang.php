...
<body>
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url() . 'admin/barang/tambah_barang' ?>">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-3">Bacode</label>
                                <div class="col-xs-9">
                                    <input name="kobar" class="form-control" type="text" id="idkobar" placeholder="Bacode..." style="width:335px;" required oninvalid="this.setCustomValidity('Data tidak boleh kosong')" oninput="setCustomValidity('')">
                                </div>
                                <div class="databarcode"></div>
                            </div>

                            <div class="form-group">
                                <label class="control-label col-xs-3">Nama Barang</label>
                                <div class="col-xs-9">
                                    <input name="nabar" id="nabar" class="form-control" type="text" placeholder="Nama Barang..." style="width:335px;" required oninvalid="this.setCustomValidity('Data tidak boleh kosong')" oninput="setCustomValidity('')">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9">
                                    <input name="harpok" class="harpok form-control" type="text" placeholder="Harga Pokok..." style="width:335px;" required oninvalid="this.setCustomValidity('Data tidak boleh kosong')" oninput="setCustomValidity('')">
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="control-label col-xs-3">Harga (Eceran 10%)</label>
                                <div class="col-xs-9">
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-3">Harga (Grosir 5%)</label>
                                <div class="col-xs-9">
                                    <input name="harjul_grosir" class="harjul_grosir form-control" type="text" placeholder="Harga Jual Grosir..." style="width:335px;" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9">
                                    <input name="stok" class="form-control" type="number" placeholder="Stok..." style="width:335px;" required oninvalid="this.setCustomValidity('Data tidak boleh kosong')" oninput="setCustomValidity('')">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9">
                                    <input name="min_stok" value="5" class="form-control" type="number" placeholder="Minimal Stok..." style="width:335px;" readonly>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn" data-dismiss="modal" value="Close" aria-hidden=" true">Tutup</button>
                        </div>
                    </form>
                </div>
            </div>
                        ...
                        <form class="form-horizontal" method="post" action="<?php echo base_url() . 'admin/barang/edit_barang' ?>">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-xs-3">Bacode</label>
                                    <div class="col-xs-9">
                                        <input name="kobar" class="form-control" type="text" value="<?php echo $id; ?>" placeholder="Bacode..." style="width:335px;" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-xs-3">Minimal Stok</label>
                                    <div class="col-xs-9">
                                        <input name="min_stok" class="form-control"  type="number" value="<?php echo $min_stok; ?>" placeholder="Minimal Stok..." style="width:335px;" readonly>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.harpok').on("input", function() {
                var harpok = $(this).val().replace(',', '', );
                var harjulEcer = harpok * 0.1;
                var harjulGro = harpok * 0.05;
                var harjuljumEcer = parseInt(harpok) + harjulEcer;
                var harjuljumGro = parseInt(harpok) + harjulGro;
                console.info("hargapokok = " + harjuljumGro);

                $('.harjul').val(harjuljumEcer);
                $('.harjul').priceFormat({
                    prefix: '',
                    //centsSeparator: '',
                    centsLimit: 0,
                ...
                $('.harjul_grosir').val(harjuljumGro);
                $('.harjul_grosir').priceFormat({
                    prefix: '',
                    //centsSeparator: '',
                    centsLimit: 0,
                    thousandsSeparator: ','
