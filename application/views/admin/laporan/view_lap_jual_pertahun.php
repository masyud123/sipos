...
<table border="0" align="center" style="width:800px; border:none;margin-top:5px;margin-bottom:0px;">
    ...
    <tr>  
        <td colspan="2" style="width:800px;paddin-left:20px;"><center><h4><b> TOKO RAHAYU</strong><br>LAPORAN DATA PENJUALAN PERTAHUN<br>
        Desa Dempelan RT.18 RW.03, Kec.Madiun, Kabupaten Madiun, Jawa Timur 63151</h4></center></td>
    </tr>

    </table>

    <hr border-width:250; color="black"style="width:900px;paddin-left:20px;">
    <table border="0" align="center" style="width:800px; border:none;margin-top:5px;margin-bottom:0px;">
    <tr>
        <td colspan="2" style="width:800px;paddin-left:20px;"><center><br><h4>LAPORAN DATA PENJUALAN<br>TAHUN <?php echo date('Y')?></h4></center></td>
    </tr>
...
<table align="center" style="width:900px; border:none;margin-top:5px;margin-bottom:20px;">
    ...
    <tr>
        <td align="right">Pemilik Toko Rahayu</td>
    </tr>
    <tr>
        <td align="right"></td>
    </tr>
