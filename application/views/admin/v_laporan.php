...
<body>
   ...
   ?>
    ...
    <div class="container">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-default" href="<?php echo base_url().'admin/laporan/view_lapbarang'?>" target="_blank"><span class="fa fa-eye"></span> Lihat</a>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-default" href="<?php echo base_url().'admin/laporan/view_lap_stok_barang'?>" target="_blank"><span class="fa fa-eye"></span> Lihat</a>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-default" href="<?php echo base_url().'admin/laporan/view_lap_data_penjualan'?>" target="_blank"><span class="fa fa-eye"></span> Lihat</a>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-default" href="#view_lap_penjualan_pertanggal" data-toggle="modal"><span class="fa fa-eye"></span> Lihat</a>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-default" href="#view_lap_penjualan_perbulan" data-toggle="modal"><span class="fa fa-eye"></span> Lihat</a>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-default" href="#view_lap_penjualan_pertahun" data-toggle="modal"><span class="fa fa-eye"></span> Lihat</a>
                     ...
                     <tr>
                        ...
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-default" href="#view_lap_laba_rugi" data-toggle="modal"><span class="fa fa-eye"></span> Lihat</a>
        ...
        <div class="modal fade" id="view_lap_penjualan_pertanggal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            <div class="modal-dialog">
            <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/laporan/view_lap_penjualan_pertanggal'?>" target="_blank">
                <div class="modal-body">
        ...
        <div class="modal fade" id="view_lap_penjualan_perbulan" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            <div class="modal-dialog">
            <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/laporan/view_lap_penjualan_perbulan'?>" target="_blank">
                <div class="modal-body">
        ...
        <div class="modal fade" id="view_lap_penjualan_pertahun" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            <div class="modal-dialog">
            <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/laporan/view_lap_penjualan_pertahun'?>" target="_blank">
                <div class="modal-body">
        ...
        <div class="modal fade" id="view_lap_laba_rugi" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            <div class="modal-dialog">
            <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/laporan/view_lap_laba_rugi'?>" target="_blank">
                <div class="modal-body">
