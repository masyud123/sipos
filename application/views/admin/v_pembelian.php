                ...
                <form action="<?php echo base_url() . 'admin/pembelian/add_to_cart' ?>" method="post">
                    <table>
                        <tr>
                            ...
                            <th style="width:300px;padding-bottom:5px;"><input type="text" name="nofak" value="<?php echo $beli_kode = $this->M_pembelian->get_kobel(); ?>" class="form-control input-sm" style="width:200px;" readonly></th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class='input-group date' id='datepicker' style="width:200px;">
                                    <input type='text' name="tgl" class="form-control" value="<?php echo date('y-m-d'); ?>" placeholder="Tanggal..." readonly />
