            ...
            <div class="col-lg-12">
                <form action="<?php echo base_url() . 'admin/penjualan/add_to_cart' ?>" method="post">
                    <table>
                        ...
                        <tr>
                            <th><input type="text" name="kode_brg" id="kode_brg" class="form-control input-sm" style="width:150px" onkeyup="search(this)"></th>
                            <!-- <th><textarea class="form-control input-sm" id="kode_brg"></textarea></th> -->
